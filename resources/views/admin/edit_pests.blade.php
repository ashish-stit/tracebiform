...
<form accept-charset="UTF-8" action="{{ url('admin/update_pests') }}" method="post">
{{  csrf_field()  }}
<!-- CSRF Token -->
<input type="hidden" name="_token" value="{{ csrf_token() }}" />
<input type="hidden" name="PestID" value="{{ $pests_edit[0]->PestID }}" />
...
value="{{ $pests_edit[0]->Description }}"/>
</div>
</div> 
<div class="container" style="margin-top: 20px;">
<div class="row">
