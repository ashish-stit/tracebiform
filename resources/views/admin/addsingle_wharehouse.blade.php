                    ...
                    <form accept-charset="UTF-8" action="{{ url('admin/singlesave') }}" method="post">
                        ...
                        <fieldset>
                            ...
                            <div id="divpalletId" style="display: none">
                                ...
                                <input type="text" id="txtPalletTag" class="form-control" />
                              <label>  Load Number </label>
                                <select class="form-control">
                                    @foreach($order_data as $data)
                                    <option value="{{$data->LoadNumber}}">{{$data->LoadNumber}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="container">
                                  <div class="row">
                                   <lable>Product Name :</lable>
                                     <select name="ProductID" id="pro_name" class="form-control" >
                                ...
                                <div class="container">
                                 ...
                                 <div class="container">
                                  <div class="row">
                                   ...
                                   <select class="form-control" name="GrowerId">
                                      @foreach($supplier_data as $data)
                                     <option value="{{$data->SupplierID}}">{{$data->ContactName}}</option>
                                     @endforeach
                                  </select>
                                 </div>
                                 </div>
